...
public class Example702_1 {
	...
	public static void inputItem() //เมทอดรับข้อมูลมา และ เช็คเงื่อนไข
	{
		int itemOrder = Integer.parseInt(JOptionPane.showInputDialog(null, 
	...
	{
		for(int i=0;i<validValues.length;i++)//เอาไว้วนหาvalidvalue 
	{
			if(item==validValues[i]) //วนเช็คเงื่อนไขprice
			{
				itemPrice = price[i];
				validItem = true;
			}
	}
		return validItem;//return ส่งกลับไปที่medthon inputItem
	}
}
